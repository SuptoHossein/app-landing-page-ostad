<template>
      ...
      <div class="aa-header">
        <nav class="navbar navbar-expand-md navbar-transparent">
          <div class="container"><img class="img-fluid pr-3 aa-logo-img" src="src/assets/images/logo.png" alt="logo"><a class="navbar-brand px-0 py-0" href="#">Awesome App</a>
        ...
        <div class="container aa-header-content text-left text-white">
          <div class="row">
            ...
            <div class="col-md-6 col-sm-12 text-right"><img class="img-fluid" src="src/assets/images/1.jpg" alt="Image"></div>
          </div>
        </div>
      </div>
    </header>
...
<div class="aa-product-features section">
  <div class="container">
    <div class="row">
      <div class="col-md-5 col-sm-12"><img class="img-fluid" src="src/assets/images/2.jpg" alt="Image"/></div>
        ...
        <div class="card card-raised page-carousel">
          <div class="carousel slide" id="aa-carousel-indicators" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
              <div class="carousel-item active"><img class="img-fluid" src="src/assets/images/3.jpg" alt="First slide"/>
                <div class="carousel-caption d-none d-md-block"> </div>
              </div>
              <div class="carousel-item"><img class="img-fluid" src="src/assets/images/4.jpg" alt="Second slide"/>
                <div class="carousel-caption d-none d-md-block"> </div>
              </div>
              <div class="carousel-item"><img class="img-fluid" src="src/assets/images/5.jpg" alt="Third slide"/>
                <div class="carousel-caption d-none d-md-block"> </div>
              </div>
      ...
      <div class="row">
        <div class="col-md-4 mb-3">
          <div class="aa-testimonials-body">
            ...
            <div class="row pt-3">
              <div class="col-lg-5 col-md-12"><img class="img-fluid" src="src/assets/images/user1.jpg" alt="Face 1"/></div>
        ...
        <div class="col-md-4 mb-3">
          <div class="aa-testimonials-body">
            <p>Awesome App is awesome and I can't imagine working on my projects without it. It has saved me countless hours of time and has increased my productivity.</p>
            <div class="row pt-3">
              <div class="col-lg-5 col-md-12"><img class="img-fluid" src="src/assets/images/user2.jpg" alt="Face 2"/></div>
              <div class="col-lg-7 col-md-12 pt-3">
        ...
        <div class="col-md-4 mb-3">
          <div class="aa-testimonials-body">
            <p>Awesome App is awesome and I can't imagine working on my projects without it. It has saved me countless hours of time and has increased my productivity.</p>
            <div class="row pt-3">
              <div class="col-lg-5 col-md-12"><img class="img-fluid" src="src/assets/images/user3.jpg" alt="Face 3"/></div>
              <div class="col-lg-7 col-md-12 pt-3">
